package org.ercsn.marketplace.ticketing.infrastructure;
...
@EnableJpaRepositories(
        basePackages = "org.ercsn.marketplace.ticketing",
        entityManagerFactoryRef = "ticketingEntityManagerFactory",
        transactionManagerRef = "ticketingTransactionManager")
@EnableRedisRepositories(basePackages = "org.ercsn.marketplace.ticketing", redisTemplateRef = "ticketingRedisTemplate")
public class TicketingConfiguration {
    ...
    @Qualifier("ticketing")
    @Bean
    public org.springframework.transaction.PlatformTransactionManager ticketingTransactionManager(@Qualifier("ticketing") LocalContainerEntityManagerFactoryBean emf) {
        return new org.springframework.orm.jpa.JpaTransactionManager(emf.getObject());
    }
