package org.ercsn.marketplace.catalog;
...
@EnableJpaRepositories(
        basePackages = "org.ercsn.marketplace.catalog",
        entityManagerFactoryRef = "catalogEntityManagerFactory",
        transactionManagerRef = "catalogTransactionManager")
@EnableMongoRepositories(basePackages = "org.ercsn.marketplace.catalog")
@EnableMongoAuditing
public class CatalogConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean catalogEntityManagerFactory(@Qualifier("catalog") DataSource dataSource,
        ...
        return builder
                ...
                .packages("org.ercsn.marketplace.catalog")
